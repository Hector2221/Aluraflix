...
const NuevaCategoria = ({ categorias }) => {
  ...
  function editarCategoria(idTabla) {
    alert(
      "¡¡IMPORTANTE!! Si modifícas el nombre de la categoria se perderán los videos guardados."
    );

    const categoriaSeleccionada = categorias.filter(
      (categoria) => categoria.id === idTabla
    );
  ...
  return (
    <div className="contenedor">
      ...
      <DataTable
        ...
        data={{ setTitulo, setDescripcion, setColorPrimario }}
      />
    </div>
  );
};
